...
function startGame() {
  ...
  goal = new goal(80,80,10,750,330);  /* width, height,ballRadius,x, y */
  ...
  obstacle_triangle_1 = new obstacle_triangle(200,390); /* X , Y */
  obstacle_triangle_2 = new obstacle_triangle(240,390);
  obstacle_triangle_3 = new obstacle_triangle(480,390);
  obstacle_triangle_4 = new obstacle_triangle(520,390);
  obstacle_triangle_5 = new obstacle_triangle(560,390);

  obstacle_long_block_1 = new obstacle_long_block(20, 100, -100, 100); /* width, height,x, y */
