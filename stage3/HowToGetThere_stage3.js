...
function startGame() {
  ...
  goal = new goal(80,80,10,750,120);  /* width, height,ballRadius,x, y */
  ...
  obstacle_long_block_1 = new obstacle_long_block(20, 200, 150, 200); /* width, height,x, y */
  obstacle_long_block_2 = new obstacle_long_block(750, 10, 300, 250);
  ...
  jumg_ball_1 = new jumg_ball(80,80,7,100, 350); /*width, height,ballRadius,x, y */
  jumg_ball_2 = new jumg_ball(80,80,7,700, 350);
  ////////////////////////////////////////////
  ///스테이지마다바뀜//////////////////////////
