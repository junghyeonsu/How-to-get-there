...
function startGame() {
  ...
  goal = new goal(80,80,10,770,330);  /* width, height,ballRadius,x, y */
  ...
  obstacle_triangle_1 = new obstacle_triangle(-300,150); /* X , Y */
  obstacle_triangle_2 = new obstacle_triangle(400,280);
  obstacle_triangle_3 = new obstacle_triangle(-550,280);
  obstacle_triangle_4 = new obstacle_triangle(-420,390);
  obstacle_triangle_5 = new obstacle_triangle(-460,390);

  obstacle_long_block_1 = new obstacle_long_block(500, 50, 150, 330); /* width, height,x, y */
  obstacle_long_block_2 = new obstacle_long_block(10, 300, 720, 300);
  obstacle_long_block_3 = new obstacle_long_block(550, 30, 300, 200);
  obstacle_long_block_4 = new obstacle_long_block(20, 100, -100, 100);
  obstacle_long_block_5 = new obstacle_long_block(20, 100, -100, 100);

  jumg_ball_1 = new jumg_ball(80,80,7,680,350); /*width, height,ballRadius,x, y */

  dash_ball_1 = new dash_ball(80,80,7,100, 350); /*width, height,ballRadius,x, y */
  dash_ball_2 = new dash_ball(80,80,7,600, 150); /*width, height,ballRadius,x, y */
