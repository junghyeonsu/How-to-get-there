...
function startGame() {
  ...
  goal = new goal(80,80,10,750,90);  /* width, height,ballRadius,x, y */
  ...
  obstacle_triangle_1 = new obstacle_triangle(400,390); /* X , Y */
  obstacle_triangle_2 = new obstacle_triangle(350,350);
  obstacle_triangle_3 = new obstacle_triangle(300,390);
  obstacle_triangle_4 = new obstacle_triangle(210,350);
  obstacle_triangle_5 = new obstacle_triangle(260,390);

  obstacle_long_block_1 = new obstacle_long_block(1000, 10, 0, 300); /* width, height,x, y */
  obstacle_long_block_2 = new obstacle_long_block(100, 500, 700, 100);
  obstacle_long_block_3 = new obstacle_long_block(20, 100, -100, 100);
  obstacle_long_block_4 = new obstacle_long_block(500, 150, 100, 100);
  obstacle_long_block_5 = new obstacle_long_block(20, 100, -100, 100);

  jumg_ball_1 = new jumg_ball(80,80,7,600, 350); /*width, height,ballRadius,x, y */
  jumg_ball_2 = new jumg_ball(80,80,10,50, 280);

  dash_ball_1 = new dash_ball(80,80,7,50, 80); /*width, height,ballRadius,x, y */
  dash_ball_2 = new dash_ball(80,80,10,650, 270); /*width, height,ballRadius,x, y */
...
function ball(width, height,ballRadius,x, y,color) {
  ...
  this.newPos = function() {
    ...
    if(isBall_circle_Colliding(myball,jumg_ball_1)||
       isBall_circle_Colliding(myball,jumg_ball_2)){
        myball.color = "blue";
      }
