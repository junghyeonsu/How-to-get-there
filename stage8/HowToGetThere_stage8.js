...
/* 새로운 오브젝트 만들었을때,
   ...
   공이랑 충돌 설정해주기 */
function startGame() {
  myball = new ball(40,40,5,30,30,"black"); /* width, height,ballRadius,x, y */
  goal = new goal(80,80,80,750,330);  /* width, height,ballRadius,x, y */
  startLocation = new start_location(40,40,5,30,30); /* width, height,ballRadius,x, y */
  ...
  obstacle_long_block_1 = new obstacle_long_block(700, 50, 0, 100); /* width, height,x, y */
  obstacle_long_block_2 = new obstacle_long_block(700, 50, 100, 230);
  ...
  jumg_ball_1 = new jumg_ball(80,80,7,-300, -300); /*width, height,ballRadius,x, y */

  dash_ball_1 = new dash_ball(80,80,7,30, 50); /*width, height,ballRadius,x, y */
  dash_ball_2 = new dash_ball(80,80,7,750, 170); /*width, height,ballRadius,x, y */
  dash_ball_3 = new dash_ball(80,80,7,-30, 300); /*width, height,ballRadius,x, y */
...
function ball(width, height,ballRadius,x, y,color) {
  ...
  this.newPos = function() {
    ...
    if(isBall_circle_Colliding(myball,dash_ball_1)||
      ...
      isBall_circle_Colliding(myball,dash_ball_3)){
        myball.color = "orange";
      }
