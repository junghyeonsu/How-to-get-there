...
function startGame() {
  ...
  goal = new goal(80,80,30,200,350);  /* width, height,ballRadius,x, y */
  ...
  obstacle_triangle_1 = new obstacle_triangle(80,390); /* X , Y */
  obstacle_triangle_2 = new obstacle_triangle(110,390);
  obstacle_triangle_3 = new obstacle_triangle(140,390);
  obstacle_triangle_4 = new obstacle_triangle(170,390);
  obstacle_triangle_5 = new obstacle_triangle(200,390);

  obstacle_long_block_1 = new obstacle_long_block(10, 320, 50, 0); /* width, height,x, y */
  obstacle_long_block_2 = new obstacle_long_block(10, 200, 50, 360);
  obstacle_long_block_3 = new obstacle_long_block(500, 10, 60, 310);
  obstacle_long_block_4 = new obstacle_long_block(10, 100, 100, 100);
  obstacle_long_block_5 = new obstacle_long_block(500, 10, 300, 390);

  jumg_ball_1 = new jumg_ball(80,80,7,80, 360); /*width, height,ballRadius,x, y */

  dash_ball_1 = new dash_ball(80,80,7,100, 250); /*width, height,ballRadius,x, y */
  dash_ball_2 = new dash_ball(80,80,7,600, 350); /*width, height,ballRadius,x, y */
